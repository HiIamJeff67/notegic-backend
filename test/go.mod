...
require (
	...
	github.com/HiIamJeff67/notegic-backend/runtimes/durablejob v0.0.0
...
replace github.com/HiIamJeff67/notegic-backend/runtimes/durablejob => ../runtimes/durablejob
