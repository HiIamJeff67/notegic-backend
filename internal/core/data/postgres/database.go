...
// defaultDB is owned by the Core process and is injected into Core repositories.
var defaultDB *gorm.DB

// DefaultDB returns the Core runtime's default connection pool.
func DefaultDB() *gorm.DB {
	return defaultDB
}

// SetDefaultDB sets the Core runtime's default connection pool.
