...
func (RoutineTag) TableName() string {
	return "RoutineTagTable"
}

// RoutineTag Table Relations
type RoutineTagRelation platformpostgres.RelationName
...
func (rt *RoutineTag) ToPrivateRoutineTag() *gqlmodels.PrivateRoutineTag {
	return &gqlmodels.PrivateRoutineTag{
		ID:        rt.Id,
		Name:      rt.Name,
		Color:     rt.Color,
		Icon:      rt.Icon.ToContractable(),
