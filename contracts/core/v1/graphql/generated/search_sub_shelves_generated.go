...
func (ec *executionContext) unmarshalInputSearchSubShelfInput(ctx context.Context, obj any) (cgqlmodels.SearchSubShelfInput, error) {
	...
	fieldsInOrder := [...]string{"rootShelfId", "prevSubShelfId", "query", "isDeletedAt", "after", "first", "sortBy", "sortOrder"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "sortBy":
			...
			data, err := ec.unmarshalOSearchSubShelfSortBy2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotegicᚑbackendᚋcontractsᚋcoreᚋv1ᚋgraphqlᚋmodelsᚐSearchSubShelfSortBy(ctx, v)
			if err != nil {
				return it, err
			}
			it.SortBy = data
...
func (ec *executionContext) marshalNSearchSubShelfEdge2ᚕᚖgithubᚗcomᚋHiIamJeff67ᚋnotegicᚑbackendᚋcontractsᚋcoreᚋv1ᚋgraphqlᚋmodelsᚐSearchSubShelfEdgeᚄ(ctx context.Context, sel ast.SelectionSet, v []*cgqlmodels.SearchSubShelfEdge) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSearchSubShelfEdge2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotegicᚑbackendᚋcontractsᚋcoreᚋv1ᚋgraphqlᚋmodelsᚐSearchSubShelfEdge(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
