...
func (ec *executionContext) unmarshalInputSearchRoutineTagInput(ctx context.Context, obj any) (cgqlmodels.SearchRoutineTagInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "sortBy":
			...
			data, err := ec.unmarshalOSearchRoutineTagSortBy2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotegicᚑbackendᚋcontractsᚋcoreᚋv1ᚋgraphqlᚋmodelsᚐSearchRoutineTagSortBy(ctx, v)
			if err != nil {
				return it, err
			}
			it.SortBy = data
...
func (ec *executionContext) marshalNSearchRoutineTagEdge2ᚕᚖgithubᚗcomᚋHiIamJeff67ᚋnotegicᚑbackendᚋcontractsᚋcoreᚋv1ᚋgraphqlᚋmodelsᚐSearchRoutineTagEdgeᚄ(ctx context.Context, sel ast.SelectionSet, v []*cgqlmodels.SearchRoutineTagEdge) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSearchRoutineTagEdge2ᚖgithubᚗcomᚋHiIamJeff67ᚋnotegicᚑbackendᚋcontractsᚋcoreᚋv1ᚋgraphqlᚋmodelsᚐSearchRoutineTagEdge(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
