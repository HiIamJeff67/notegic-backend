...
type BlockPackYjsRepositoryInterface interface {
	LoadDocumentAndUpdates(blockPackId uuid.UUID, opts ...RepositoryOptions) (*schemas.BlockPackYjsDocument, []schemas.BlockPackYjsUpdate, error)
	AppendUpdate(blockPackId uuid.UUID, input inputs.AppendBlockPackYjsUpdateInput, opts ...RepositoryOptions) (int64, error)
	GetCompactableYjsDocumentWithUpdates(blockPackId uuid.UUID, opts ...RepositoryOptions) (*schemas.BlockPackYjsDocument, []schemas.BlockPackYjsUpdate, error)
	ApplyCompactedYjsDocument(blockPackId uuid.UUID, input inputs.ApplyCompactedBlockPackYjsDocumentInput, opts ...RepositoryOptions) (bool, error)
	DeleteCompactedUpdates(input inputs.DeleteCompactedBlockPackYjsUpdatesInput, opts ...RepositoryOptions) (int64, error)

	BulkCheckPermissionsAndGetManyByIds(blockPackIds []uuid.UUID, opts ...RepositoryOptions) ([]bool, []BlockPackYjsDocumentWithUpdates, error)
	BulkCheckProjectionDocumentsByIds(blockPackIds []uuid.UUID, opts ...RepositoryOptions) ([]BlockPackYjsDocumentWithUpdates, error)
	BulkApplyCompactedYjsDocuments(inputs []inputs.BulkApplyCompactedBlockPackYjsDocumentInput, opts ...RepositoryOptions) ([]uuid.UUID, error)
}
