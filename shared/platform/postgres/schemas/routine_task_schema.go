...
type RoutineTask struct {
	...
	Status            cenums.RoutineTaskStatus  `json:"status" gorm:"column:status; type:\"RoutineTaskStatus\"; not null; default:'Idle';"`
	...
	Period            *cenums.RoutinePeriod     `json:"period" gorm:"column:period; type:\"RoutinePeriod\"; default:null;"`
