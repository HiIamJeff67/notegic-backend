...
type UsersToBillingPlans struct {
	...
	Status          cenums.UsersToBillingPlansStatus `json:"status" gorm:"column:status; type:\"UsersToBillingPlansStatus\"; not null;"`
...
func (UsersToBillingPlans) TableName() string {
	return postgres.TableName_UsersToBillingPlansTable.String()
}

// UsersToBilling Plans Relations
type UsersToBullingPlansRelation postgres.RelationName
