...
type UserSetting struct {
	...
	Language             cenums.Language                `json:"language" gorm:"column:language; type:\"Language\"; not null; default:'English';"`
	Density              cenums.UserSettingDensity      `json:"density" gorm:"column:density; type:\"UserSettingDensity\"; not null; default:'Balanced';"`
	StartSurface         cenums.UserSettingStartSurface `json:"startSurface" gorm:"column:start_surface; type:\"UserSettingStartSurface\"; not null; default:'Dashboard';"`
...
func (UserSetting) TableName() string {
	return postgres.TableName_UserSettingTable.String()
}
