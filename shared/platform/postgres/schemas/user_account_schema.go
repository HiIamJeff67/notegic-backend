...
// UserAccount is the shared persistence model for trusted runtimes. It is
// intentionally not a public account view or DTO because it contains auth
// credentials and account-internal usage counters.
type UserAccount struct {
	...
	CountryCode         *cenums.CountryCode `json:"countryCode" gorm:"column:country_code; type:\"CountryCode\";"` // validate:"omitnil,iscountrycode"
...
func (UserAccount) TableName() string {
	return postgres.TableName_UserAccountTable.String()
}
