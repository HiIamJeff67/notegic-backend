...
type UserInfo struct {
	...
	Gender             cenums.UserGender `json:"gender" gorm:"column:gender; type:\"UserGender\"; not null; default:'PreferNotToSay'"` // validate:"omitnil,isgender"
	Country            *cenums.Country   `json:"country" gorm:"column:country; type:\"Country\";"`                                     // validate:"omitnil,iscountry"
...
func (UserInfo) TableName() string {
	return postgres.TableName_UserInfoTable.String()
}

/* ============================== Relative Type Conversions ============================== */

func (ui *UserInfo) ToPublicUserInfo() *cgqlmodels.PublicUserInfo {
	return &cgqlmodels.PublicUserInfo{
