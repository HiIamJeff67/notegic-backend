...
type ItemScopeInterface interface {
	PassPermissionCheck(id uuid.UUID, itemType cenums.ItemType, userId uuid.UUID, permissions []cenums.AccessControlPermission) func(db *gorm.DB) *gorm.DB
	PassPermissionChecks(itemIdentities []types.Pair[uuid.UUID, cenums.ItemType], userId uuid.UUID, permissions []cenums.AccessControlPermission) func(db *gorm.DB) *gorm.DB
...
func (sc *ItemScope) PassPermissionCheck(id uuid.UUID, itemType cenums.ItemType, userId uuid.UUID, permissions []cenums.AccessControlPermission) func(db *gorm.DB) *gorm.DB {
...
func (sc *ItemScope) PassPermissionChecks(itemIdentities []types.Pair[uuid.UUID, cenums.ItemType], userId uuid.UUID, permissions []cenums.AccessControlPermission) func(db *gorm.DB) *gorm.DB {
	return func(db *gorm.DB) *gorm.DB {
		// ItemTable is a projection with root_shelf_id, so permission can be checked without joining the concrete item tables.
